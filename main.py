...
def main(page: ft.Page):
    ...
    def recuperar_password(e):
        ...
        def enviar(e):
            ...
            if user:
                ...
                msg_email = MIMEText(f"Código: {codigo_recuperacion}")
                msg_email["Subject"] = "Recuperación"
    ...
    def abrir_sistema(usuario):
                    ...
                    ft.Container(
                        ...
                        content=ft.Row(
                            ...
                            controls=[
                                ...
                                ft.Row([
                                    ft.IconButton(ft.Icons.EDIT, on_click=lambda e, x=l: editar(x)),
                                    ft.IconButton(ft.Icons.DELETE, on_click=lambda e, id=l[0]: borrar(id))
                                ])
                            ]
                        )
                    )
        ...
        def editar(l):
            libro_id["id"] = l[0]
            t1.value, t2.value, t3.value, t4.value = l[1], l[2], l[3], str(l[4])
            page.update()
        ...
        def guardar(e):
            if libro_id["id"]:
                cursor.execute(
                    ...
                    (t1.value, t2.value, t3.value, t4.value, libro_id["id"])
                )
            else:
                agregar(e)
